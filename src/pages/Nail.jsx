...
function Nail() {
  return (
    <div className="service-nail-page">
      <div className="text">
        <div className="heder-text">
          <h1>Nail Art & Care</h1>
          <p>
            Elevate your style with stunning nail art designs, professional
            manicures, and pampering treatments tailored just for you.
          </p>
        </div>
